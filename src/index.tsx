    ...
    <Section style="accentTransition">
      <Logos
        ...
        logos={[
          {
            alt: "Logo 1",
            src: "img/static/ogoipsum-212.svg",
          },
          {
            alt: "Logo 2",
            src: "img/static/ogoipsum-217.svg",
          },
          {
            alt: "Logo 3",
            src: "img/static/ogoipsum-239.svg",
          },
          {
            alt: "Logo 4",
            src: "img/static/ogoipsum-244.svg",
          },
          {
            alt: "Logo 5",
            src: "img/static/ogoipsum-250.svg",
          },
          {
            alt: "Logo 6",
            src: "img/static/ogoipsum-286.svg",
          },
        ]}
      />
    </Section>

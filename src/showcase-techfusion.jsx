...
export default (props) => (
  <PageWrapper>
    ...
    <Section style="accent" width="wide" align="left" mode="list" spaceAfter="default">
      <Headline
        align="left"
...
EcoTech Solutions, a forward-thinking company in the sustainable PV and wind power industry, sought a way to streamline their development process and enhance their brand consistency across platforms.
    ...
    <Section style="accent" width="full" align="left" mode="list" spaceAfter="none" spaceBefore="none">
      <TextMedia
        text={``}
        media={[
          {
    ...
    <Section style="default" width="wide" align="left" mode="list" spaceAfter="default">
      <TextMedia
        text={`
### Our Solution: 
...
- Emily Johnson, Director of Digital Strategy at EcoTech Solutions`}
    ...
    <Section style="default" width="wide" align="left" mode="list" spaceAfter="default" inverted>
      <TextMedia
        text={`
### Result: 
